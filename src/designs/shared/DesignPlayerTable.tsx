            ...
            {team.players.map((player) => {
              ...
              return (
                <tr key={player.personId}>
                  ...
                  {didPlay
                    ? columns.map((column) => <td key={column.label}>{column.value(player)}</td>)
                    : <td colSpan={columns.length}>{player.comment || "DNP — Coach’s Decision"}</td>}
                </tr>
              );
            })}
          </tbody>
