...
const PlayerTable = ({team}: PlayerTableProps) => {
  return (
    <div className="pb-4">
      <h1 className="text-lg font-bold p-4 text-center dark:text-slate-50 text-neutral-950">
        {team.teamName}
      </h1>

      <div className="overflow-x-auto">
        <table className="table-auto mx-auto dark:text-slate-50 text-neutral-950">
          <thead>
            <tr className="text-xs">
              <th className="pr-[6px] min-w-36">PLAYER</th>
